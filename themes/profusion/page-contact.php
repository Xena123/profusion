...
<body class="green__stylers">
    ...
    <main class="b-content">
      ...
      <div class="container">
        <div class="section-b w980">
          <div class="row b-30 contact-row-p">
            ...
            ?>
            <div class="col-lg-6 b30 contact-col-p">
              <div class="address__box address__l">
                <div class="address__box__image">
                  <?php if($img): ?>
                    <img src="<?php echo $img['sizes']['contact']; ?>" alt="">
                  <?php else: ?>
                    <img src="<?php echo get_template_directory_uri(); ?>/img/default-contact.png" alt="">
                  <?php endif; ?>
                </div>
