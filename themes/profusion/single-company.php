...
<body class="green__stylers single-company">
  	<div class="b-wrap">
		...
		<main class="b-content">
				...
				<div class="section-b">
					<div class="w-750 w-750-flex">
						...
						<ul class="list share__list">
							...
							<li class="lstForBtn">
								<a href="<?php echo get_permalink('521'); ?>#tribe-talk" class="main-btn main-red-btn">View all tribe talk</a>
							</li>
						</ul>
					</div>
				</div>
			...
			<div class="container red__stylers" >
