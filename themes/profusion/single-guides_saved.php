					...
					<div class="main-slider-inner">
						<div class="container">
							<div class="main-slider-info">
								...
								<?php if($altertitle = get_field('altertitle')): ?>
									<?php echo $altertitle; ?>
								<?php else: ?>
									<h2><?php the_title(); ?></h2>
								<?php endif; ?>
										...
										<li>
											...
											<div class="sub__share">
												<ul class="sub__share--list">
													<li><a href="https://api.addthis.com/oexchange/0.8/forward/email/offer?url=https%3A%2F%2Fwww.addthis.com%2F&pubid=ra-42fed1e187bae420&title=AddThis%20%7C%20Home&ct=1" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/mail.svg" alt=""></a></li>
													<li><a href="https://api.addthis.com/oexchange/0.8/forward/linkedin/offer?url=https%3A%2F%2Fwww.addthis.com%2F&pubid=ra-42fed1e187bae420&title=AddThis%20%7C%20Home&ct=1" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/in.svg" alt=""></a></li>
													<li><a href="https://api.addthis.com/oexchange/0.8/forward/twitter/offer?url=https%3A%2F%2Fwww.addthis.com%2F&pubid=ra-42fed1e187bae420&title=AddThis%20%7C%20Home&ct=1" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/tw.svg" alt=""></a></li>
													<li><a href="https://api.addthis.com/oexchange/0.8/forward/facebook/offer?url=https%3A%2F%2Fwww.addthis.com%2F&pubid=ra-42fed1e187bae420&title=AddThis%20%7C%20Home&ct=1" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/fb.svg" alt=""></a></li>
												</ul>
											</div>
										</li>
										<li>											
											...
											<div class="sub__share">
												<ul class="sub__share--list">
													...
													<li><a href="<?php echo $file_to_download; ?>" download target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/mac.svg" alt=""></a></li>
													<?php endif; ?>
													<?php if($file_to_download_mob = get_field('file_to_download_mob')): ?>
													<li><a href="<?php echo $file_to_download_mob; ?>" download target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/tablet.svg" alt=""></a></li>
													<?php endif; ?>
												</ul>
											</div>
										</li>
			...
			<div class="container" >
				<section class="tac section-b">
					...
					<div class="tac for-center-btn">
						<a href="<?php echo get_permalink('521'); ?>" class="main-btn main-red-btn">Visit Knowledge</a>
					</div>
				</section>
			</div>
			<?php endif; ?>
